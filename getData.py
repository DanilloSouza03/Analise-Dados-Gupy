...
# Pega a altura da página antes de começar a rolagem
...
for vaga in card_vagas:
    ...
    dict_vagas["empresa"].append(empresa)
    dict_vagas["cargo"].append(cargo)
    dict_vagas["localizacao"].append(localizacao)
    dict_vagas["modalidade"].append(modalidade)
    dict_vagas["contrato"].append(contrato)
    dict_vagas["pcd"].append(pcd)
    dict_vagas["data"].append(data)
